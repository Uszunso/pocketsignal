...
# الأكواد البصرية المتقدمة (CSS) للواجهة الملكية الفاخرة
st.markdown("""
    <style>
    .stApp {
...
# إدارة الذاكرة للتنقل التلقائي والسلس
...
# ----------------- الشاشة 4: شاشة توليد وتكرار الإشارات الحية -----------------
